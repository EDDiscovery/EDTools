...
namespace EliteDangerousCore
{
    public class ShipModuleData
    {
        ...
        #region FROM COROLIS  NEVER EVER do this manually, its done using a corolis-data scanner in testEDDTest!
        ...
        #region ship data FROM COROLIS - use the EDDTest scanner
