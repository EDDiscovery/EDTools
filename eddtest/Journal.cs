...
namespace EDDTest
{
    public static partial class Journal
    {
        ...
        public static string Help(string eventtype)
        {
            ...
            s += he("Scans", "ScanPlanet name", eventtype);
            s+=he("", "ScanStar, ScanEarth", eventtype);
